      ...
      {open && (
        <div className="help-overlay" onClick={() => setOpen(false)}>
          <div className="help-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <p><strong>Auto-playlist</strong> - paste a Spotify playlist URL and when the queue runs empty, the next track from that playlist will automatically be queued. If you set an auto-playlist with nothing queued, the first track starts playing right away. Keeps the music going when nobody's actively adding songs. The next 10 upcoming playlist tracks are shown below the queue so everyone can see what's coming. The host can drag to reorder and shuffle the upcoming auto-playlist tracks. You can also drag tracks from the auto-playlist into the queue, or click the + button on any auto-playlist track to add it.</p>
