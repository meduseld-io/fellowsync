...
<!-- TODO: Screenshot - Spotify Developer Dashboard showing "Create app" button -->

Set the redirect URI to match your FellowSync instance (e.g. `https://fellowsync.example.com/callback`).

<!-- TODO: Screenshot - Spotify app settings showing redirect URI field -->

Note your Client ID and Client Secret from the app settings page.

<!-- TODO: Screenshot - Spotify app settings showing Client ID and Client Secret -->
